...
<body>
        ...
        int id, price,flag=0,price_sum=0; ;
        ...
        if(num.equals("num")&&flag==0){
        	flag=1;
        	out.println("<script>alert('수량을 입력해 주세요');history.back();</script>");
        } 
        price_sum=price* Integer.parseInt(num);
        %>
		...
		try {
	     ...
	     String sql1 = "insert into mycart_tbl values ('" + cname + "','"+ name +"','"+ num +"',"+price_sum+")";
	     try{
