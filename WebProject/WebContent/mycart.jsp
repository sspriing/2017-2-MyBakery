...
<%
	...
	String[] priceSum=new String[100];
    ...
    try {
          ...
          String sql = "select * from mycart_tbl where name = '"+ name+"'";
    ...
    while(rs.next()){
		...
		priceSum[i]=rs.getString("price_sum");
		i++;
    }
...
<div id="wrap">
        ...
        <center style=" margin-top:20px">
				...
				<tr height="50"><th colspan="3"><font size="5">내 장바구니</font></th></tr>
				<tr height="40"><td>상품명</td><td>수량</td><td>금액</td></tr>
				<%    for(int j=0;j<i;j++){%>
				<tr><td style="width:200px"><%=product[j] %></td> <td > <%=productNum[j] %> </td> <td > <%=priceSum[j] %> </td> </tr>
               <%} %><tr><th colspan="3"><font size="5"><a href="order.jsp"><input type="button" value="주문하기"/>&nbsp;</a><a href="deleteMycart.jsp"><input type="button" value="장바구니 비우기"/></a></font></th></tr>
				</table>
					<!-- out.println(product[j]);
			    	out.println(productNum[j]); -->
