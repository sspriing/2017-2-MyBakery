...
<body>
<%
String name="",e_mail="",phone="",id="";
String dname="",de_mail="",dphone="",did="";
...
if(name.equals(dname)&&e_mail.equals(de_mail)&&phone.equals(dphone)){
	if(byPhone==null){out.println("<script>alert('이메일로 비밀번호를 발송했습니다.');location.href='login.jsp';</script>");}
	else{out.println("<script>alert('메세지로 비밀번호를 발송했습니다.');location.href='login.jsp';</script>");}
}
